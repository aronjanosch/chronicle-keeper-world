...
def segments_to_plain_text(segments: list[dict]) -> str:
    """Convert segments to simple plain text."""
    lines = []
...
def save_plain_text_transcript(segments: list[dict], output_path: str | Path) -> str:
...
def save_transcription_result(
    ...
    save_plain_text_transcript(segments, text_path)
